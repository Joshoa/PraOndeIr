...
class PlacesTableViewController: UITableViewController {
    ...
    var svNoPlaces: NoPlaceStackView!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        configureNavigationBar(title: "Pra onde ir")
    ...
    //MARK: - Methods
    private func configNoPlacesStackView() {
        svNoPlaces = NoPlaceStackView.initializeFromNib()
        svNoPlaces.setText("Cadastre os locais que deseja ir\nclicando no botão + acima")
    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if places.count > 0 {
            ...
            tableView.backgroundView = svNoPlaces
        }
        return places.count
    }
